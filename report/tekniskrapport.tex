...
\end{figure}
		...
		För att förtydliga skillnaden mellan delblock, tillstånd och databussar i nedanstående stycken är delblocken skrivna i \emph{kursiv text}, tillstånd i \textbf{fetstilt text} och databussar i \textbf{\emph{kursiv fetstilt text}}.\\
